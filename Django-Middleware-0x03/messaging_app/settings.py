...
SECRET_KEY = 'django-insecure-y8h62e9$)@c$37-sp8)gfrqy6l#e%=&1^djf-q#hg@==^-$4k+'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        ...
        'messaging_app.chats.permissions.IsAuthenticatedUser',
    ],
...
MIDDLEWARE = [
    ...
    'Django-Middleware-0x03.middleware.RolePermissionMiddleware',
]
